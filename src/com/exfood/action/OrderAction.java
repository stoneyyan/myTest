...
import com.exfood.dao.OrderDao;
import com.exfood.model.*;
...
public class OrderAction extends ActionSupport{
	...
	public String addOrder() throws Exception{
		...
		customer = customerDao.QueryCustomerInfo(customer.getName()).get(0);//get(0)表示相同名字取第一个
		Order ord =new Order();
		ord.setCustomer(customer);
		ord.setFood(food);
		//因为是“来一份”，所以置为1
		ord.setFoodnum(1);
		ord.setTotal(foodDao.getFoodByfoodid(food.getFoodid()).getUnitprice()*1);
